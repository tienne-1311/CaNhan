    ...
    <div class="wapprer d-flex gap-3">
        ...
        <div class="content-wrapper" style="width: 100%; padding-right: 20px; padding-bottom: 20px;">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="py-3">Sửa tài khoản</h2>
            </div>
            <form action="" method="post" enctype="multipart/form-data">

                <div class="mb-3">
                    <label for="hovaten" class="form-label fs-6">Họ và tên</label>
                    <input type="text" class="form-control" id="hovaten" name="name_user" value="<?= $user->name_user ?>">
                </div>

                <div class="mb-3">
                    <label for="sodienthoai" class="form-label fs-6">Số điện thoại</label>
                    <input type="text" class="form-control" id="sodienthoai" name="tel" value="<?= $user->tel ?>">
                </div>

                <div class="mb-3">
                    <label for="email" class="form-label fs-6">Email</label>
                    <input type="text" class="form-control" id="email" name="gmail_user" value="<?= $user->gmail_user ?>">
                </div>

                <div class="mb-3">
                    <label for="matkhau" class="form-label fs-6">Mật khẩu</label>
                    <input type="text" class="form-control" id="matkhau" name="password_user" value="<?= $user->password_user ?>">
                </div>

                <div class="mb-3">
                    <label for="diachi" class="form-label fs-6">Địa chỉ</label>
                    <textarea cols="30" rows="10" class="form-control" id="diachi" name="address">
                    <?= $user->address ?>
                    </textarea>
                </div>
                ...
                <div class="img-preview mb-5 w-25 h-25">
                    ...
                    <img src="<?= ROOT_PATH . "assets/" . $user->avatar ?>" id="img-preview" class="w-100">
                </div>
