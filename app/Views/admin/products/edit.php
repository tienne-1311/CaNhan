    ...
    <div class="wapprer d-flex gap-3">
        ...
        <div class="content-wrapper" style="width: 100%; padding-right: 20px; padding-bottom: 20px;">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="py-3">Upload sản phẩm</h2>
            </div>
            <form action="" method="post" enctype="multipart/form-data">

                <div class="mb-3">
                    <label for="ten_san_pham" class="form-label fs-6">Tên sản phẩm</label>
                    <input type="text" class="form-control" id="ten_san_pham" name="title_sanpham" value="<?= $products->title_sanpham ?>">
                </div>

                <div class="mb-3">
                    <label for="gia_san_pham" class="form-label fs-6">Giá sản phẩm</label>
                    <input type="text" class="form-control" id="gia_san_pham" name="price" value="<?= $products->price ?>">
                </div>

                <div class="mb-3">
                    <label for="mo_ta" class="form-label fs-6">Mô tả</label>
                    <textarea cols="30" rows="10" class="form-control" id="mo_ta" name="mota_sanpham">
                    <?= $products->mota_sanpham ?>
                    </textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="id_danhmuc" id="danhmuc">
                        <?php foreach ($categorieDM as $cate) : ?>
                            <li>
                                <a href="<?= ROOT_PATH ?>categorieDM?id=<?= $cate->id_danhmuc ?>">
                                    <?= $cate->name_danhmuc ?>
                                </a>
                            </li>
                        <?php endforeach ?>
                ...
                <div class="img-preview mb-5 w-25 h-25">
                    ...
                    <img src="<?= ROOT_PATH . "assets/" . $products->img_sanpham ?>" id="img-preview" class="w-100">
                </div>
                <input type="hidden" name="id_sanpham" value="<?= $products->id_sanpham ?>">
